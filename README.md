...
[cite_start]Експерименти проводилися для обсягів до 1 000 000 елементів із початковим розміром 8, 32 та 128[cite: 27, 28].
...
### Графік результатів
###Графіки результатів прикріплений окремим файлом
